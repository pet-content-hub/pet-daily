            ...
            <div class="form-group">
              <label class="checkbox-label">
                <input 
                  ...
                  class="form-checkbox"
                >
                <span class="checkbox-text">活跃状态</span>
              </label>
              <p class="form-hint">
                取消勾选将归档此猫咪，不会显示在活跃列表中
              </p>
            </div>
          </div>
        </form>
...
async function handleSubmit() {
  ...
  try {
    ...
    showErrorMessage(error.message || '更新猫咪失败，请重试')
  } finally {
...
onMounted(() => {
  if (props.cat) {
    form.name = props.cat.name || ''
    form.breed = props.cat.breed || ''
    form.gender = props.cat.gender || ''
    form.birth_date = props.cat.birth_date || ''
    form.color = props.cat.color || ''
    form.weight = props.cat.weight?.toString() || ''
    form.microchip_id = props.cat.microchip_id || ''
    form.avatar_url = props.cat.avatar_url || ''
    form.is_active = props.cat.is_active !== false
  }
})
</script>
